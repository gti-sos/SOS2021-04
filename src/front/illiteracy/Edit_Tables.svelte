<script>
    ...
    nuevoElemento.female_illiteracy_rate = parseFloat(nuevoElemento.female_illiteracy_rate);
    nuevoElemento.male_illiteracy_rate = parseFloat(nuevoElemento.male_illiteracy_rate);
    nuevoElemento.adult_illiteracy_rate = parseFloat(nuevoElemento.adult_illiteracy_rate);
    nuevoElemento.young_illiteracy_rate = parseFloat(nuevoElemento.young_illiteracy_rate);
    const res = await fetch(BASE_API_PATH, {
      method: "POST",
    ...
    <div style="padding:1%">
            <Row>
                <Col>
                    ...
                    <a href="#/illiteracy"><Button style="background-color: blue;">Página principal</Button></a>
                    {:else}
        ...
        <Table>
            ...
            <!-- RELLENO LA TABLA CON DATOS -->
                ...
                <tr  style="text-align: center;">
                    <th>{stat.year}</th>
                    <th>{stat.country}</th>
                    <th>{stat.female_illiteracy_rate}</th>
                    ...
                    <th><a href='#/illiteracy/{stat.country}/{stat.year}'><button class="btn btn-warning">Editar</button></a></th>
                </tr>
                {/each}
            </tbody>
    ...
    {#if datosRecibidos.length!=0} <!--Por el contrario si no se ha hecho ninguna búsqueda -->
        <Table>
            ...
            <tr>
                ...
                <td><input type="number" placeholder="8.474"  bind:value={nuevoElemento.female_illiteracy_rate}/></td>
                <td><input type="number" placeholder="12.849"  bind:value={nuevoElemento.male_illiteracy_rate}/></td>
                <td><input type="number" placeholder="26.983"  bind:value={nuevoElemento.adult_illiteracy_rate}/></td>
                <td><input type="number" placeholder="13.6"  bind:value={nuevoElemento.young_illiteracy_rate}/></td>
